...
namespace Protobuf.CodeFixes.Test.Verifiers
{
    /// <summary>
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static void VerifyDiagnosticLocation(DiagnosticAnalyzer analyzer, Diagnostic diagnostic, Location actual, DiagnosticResultLocation expected)
        {
            ...
            if (actualLinePosition.Line > 0)
            {
                ...
                {
                    throw new Exception($"Expected diagnostic to be on line \"{expected.Line}\" was actually on line \"{actualLinePosition.Line + 1}\"\r\n\r\nDiagnostic:\r\n    {FormatDiagnostics(analyzer, diagnostic)}\r\n");
                }
            }
            ...
            if (actualLinePosition.Character > 0)
            {
                ...
                {
                    throw new Exception($"Expected diagnostic to start at column \"{expected.Column}\" was actually at column \"{actualLinePosition.Character + 1}\"\r\n\r\nDiagnostic:\r\n    {FormatDiagnostics(analyzer, diagnostic)}\r\n");
                }
            }
        }
